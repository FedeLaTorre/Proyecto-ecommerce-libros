...
$seccionesDisp = ['home', 'productos', 'detalle', 'contacto', '404'];
...
<head>
    <meta charset="UTF-8">
    <title>Federico La Torre Primer TP DW TN3A 2019</title>
...
<body>
    <header class="header">
        ...
        <nav>
            <ul>
                ...
                <li><a href="index.php?s=detalle">Detalle</a></li>
    ...
    <footer class="footer">
        <ul>
            ...
            <li>Trabajo práctico 1. Tercer semestre Escuela Da Vinci. 2019</li>
